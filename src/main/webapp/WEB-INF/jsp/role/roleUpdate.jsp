...
<html>
	...
	<body>
		<div id="updateDiv" class="easyui-panel" title="" data-options="fit:true" style="padding:20px">
			<div>
				<form action="roleController_saveRole" id="addrole"
					name="addrole" method="post" >
						<table>
							<tr>
								...
								<td align="left">
									<input type="text" name="rolecode" class="easyui-textbox" readonly="readonly"
										id="rolecode"  value="${roleinfo.rolecode}" style="width:180px;"></input>
								</td>
							</tr>
							<tr>
								<td align="right" style="width:110px;">
								...
								<td align="left">
									<input type="text" name="rolename" class="easyui-textbox" value="${roleinfo.rolename}"
								...
								<td align="left">
									...
									url:'dictionaryController_getDictionaryForComboBox?datatype=instclass&required=true',value:'${roleinfo.instclass}'"></input>
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td align="left" colspan="4">
									<input id="description" name="description" class="easyui-textbox" type="text" data-options="multiline:true,validType:'length[0,100]'" value="${roleinfo.description}" style="width:100%;height:50px">
								</td>
							</tr>
						</table>

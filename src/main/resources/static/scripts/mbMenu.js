	...
	$.fn.extend({
		buildMbMenu: function(op,m,type,e){
			...
			if (isBoxmenu) {
				...
				//this will break <a rel=text> - if there are nested a's
			...
			// 这里标记最小弹出左边距
			//var _swidth = this.menu.children(0).outerWidth();
			//if(l+_swidth > $("#menubar").outerWidth()){
			//	console.debug("fdsa");
			//}
			//console.debug($("#menubar").outerWidth(), parseInt(l), _swidth);
